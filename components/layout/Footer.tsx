...
export default function Footer() {
  return (
    <footer className="relative bg-[#0B1120] border-t border-white/[0.06]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-[#9BA8BB]">HIPAA Compliant</span>
            </div>
            {/* Social Icons */}
            <div className="flex gap-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-[#9BA8BB] hover:text-[#2DD4BF] hover:border-[#2DD4BF]/30 transition-all"
              >
          ...
          {/* Column 2: Services */}
          <div>
            <h3 className="text-sm font-semibold font-sora text-[#F0EDE8] uppercase tracking-wider mb-5">
              Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="tel:2816669211"
                  className="flex items-start gap-3 text-sm text-[#9BA8BB] hover:text-[#2DD4BF] transition-colors"
                >
              ...
              <li className="flex items-start gap-3 text-sm text-[#9BA8BB]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 block w-full text-center px-4 py-2.5 bg-[#2DD4BF]/10 border border-[#2DD4BF]/30 text-[#2DD4BF] text-sm font-semibold rounded-xl hover:bg-[#2DD4BF] hover:text-[#0B1120] transition-all duration-200"
            >
              Book Appointment
            </a>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#9BA8BB]/60">
            © {new Date().getFullYear()} IV-LYTES & Wellness — BAABA LLC. All rights reserved.
          </p>
          <p className="text-xs text-[#9BA8BB]/60 text-center sm:text-right max-w-md">
