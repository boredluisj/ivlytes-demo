        ...
        <AnimateOnScroll className="mb-8">
          <GlassCard className="p-5 flex items-start gap-4">
            ...
            <p className="text-sm text-[#A0AEC0]">
              <strong className="text-[#F5F5F5]">Attorney Review Disclaimer:</strong> This document should be reviewed by a qualified attorney to ensure it meets all applicable legal requirements in your jurisdiction.
            </p>
          </GlassCard>
        </AnimateOnScroll>

        <AnimateOnScroll>
          <h1 className="text-3xl font-sora font-bold text-[#F5F5F5] mb-4">Terms of Use</h1>
          ...
          <div className="space-y-8 text-[#A0AEC0] text-sm leading-relaxed">
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">1. Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">2. Cash-Pay Disclosure</h2>
              <p className="font-medium text-[#F5F5F5] mb-2">IV-LYTES &amp; Wellness is a cash-pay only clinic.</p>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">3. Medical Disclaimer</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">4. Service Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">5. Limitation of Liability</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">6. Arbitration Clause</h2>
              <p className="font-medium text-[#F5F5F5] mb-2">PLEASE READ THIS SECTION CAREFULLY.</p>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">7. Governing Law</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">8. Changes to Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-sora font-semibold text-[#F5F5F5] mb-4">9. Contact</h2>
